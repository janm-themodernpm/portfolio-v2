...
A personal portfolio for Jan Patrick McGhee, senior PM. Built as static HTML/CSS/JS with no build step. The design commits to an **editorial** direction: serif-led typography, generous whitespace, printed-page rhythm, and restrained color. It borrows from long-form magazine layouts and PM portfolios — confident, text-first, and unapologetic about reading time.
